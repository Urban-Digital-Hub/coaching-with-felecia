  ...
  return (
    <div className="d-flex align-items-center justify-content-center" style={{ minHeight: '70vh', background: '#f8f9fa' }}>
      <div className="text-center p-4">
        <h1 style={{ fontSize: '6rem', marginBottom: '0.25rem', color: COLOR.secondary }}>404</h1>
        <h2 style={{ color: COLOR.secondary, marginBottom: '0.75rem' }}>Page Not Found</h2>
        ...
        <div className="d-flex justify-content-center gap-2 mt-3">
          ...
          <a href="#" className="btn btn-outline-secondary" style={{ color: COLOR.secondary }} onClick={(e) => e.preventDefault()}>
            Contact Support
          </a>
        </div>
      </div>
